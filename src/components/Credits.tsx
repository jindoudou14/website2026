...
const Credits = () => {
    ...
    <div className = "page">
        <img className="top-background" src="logos and images/credit_background.png" alt="Background-top"></img>
        <img className="cast" src="logos and images/insideout_cast.png"></img>
        ...
        <div className="credit-card">
            ...
            <div className = "creds">
                ...
                <p>This website was created for the CRC Robotics Competition.</p>
                <p>The design and theme are inspired by the film <em>Inside Out 2 </em> (2024).</p>
